...
public class MainActivity2 extends AppCompatActivity implements LocationListener {
    ...
    private void sendMessageWithCoordinates(double latitude, double longitude) {
        String message = "Estas son Mis coordenadas: " + latitude + ", " + longitude;
            ...
            public void onCallStateChanged(int state, String phoneNumber) {
                switch (state) {
                    case TelephonyManager.CALL_STATE_RINGING:
                        if (!callStarted) {
                            Toast.makeText(MainActivity2.this, "Llamada del Numero: " + phoneNumber, Toast.LENGTH_SHORT).show();
                            callStarted = true;
                            callEnded = false;
                            callCancelled = false;
                    ...
                    case TelephonyManager.CALL_STATE_IDLE:
                        if (callStarted && !callEnded && !callCancelled) {
                            ...
                            String numeroGuardado = numeroGuardadoTextView.getText().toString();
                            if (phoneNumber.equals(numeroGuardado)) {
                                Toast.makeText(MainActivity2.this, "Llamando de nuevo", Toast.LENGTH_SHORT).show();
